 ...
 * - redirect_uri=https://echo.example.com/api/crm/connect/callback (or similar)
 ...
 *
 * Behavior (scaffold):
 * - Validates required parameters and returns a simulated "authorize_url" that Echo would open.
