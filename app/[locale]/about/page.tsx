                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <div className="space-y-4 text-gray-300 leading-relaxed">
                                    ...
                                    <p>
                                        We set out to build a different kind of CMS. One that works for you, not the other way around.
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        {groups.length > 0 ? (
                            <div className="space-y-8">
                                {groups.map((group) => {
                                    // Determine max width and columns based on member count to replicate original layout feel
                                    const isTwoOrLess = group.members.length <= 2;
                                    const containerClass = isTwoOrLess
                                        ? "max-w-3xl sm:grid-cols-2"
                                        : "max-w-6xl sm:grid-cols-2 md:grid-cols-3";

                                    return (
                                        <div key={group.id} className={`grid grid-cols-1 ${containerClass} gap-8 mx-auto`}>
                            ...
                            // Fallback to Hardcoded if DB is empty (First render before CMS seed)
                            <>
                                {/* Row 1: 4 columns */}
