...
export default function PricingClient() {
    ...
    return (
        <main className="pt-32 pb-20 overflow-x-hidden max-w-full">
            {/* Hero Section */}
    ...
    return (
        ...
        >
            ...
            <Link href="/dashboard" className="w-full mt-auto">
                <Button
                    variant={buttonVariant === "primary" ? "glow" : "outline"}
                    className={`w-full py-6 text-lg rounded-full font-semibold ${buttonVariant !== "primary" ? "bg-transparent border border-white/20 hover:bg-white/10 text-white" : ""}`}
                >
                    {buttonText}
                </Button>
            </Link>
            ...
            <div className="md:hidden p-4 space-y-4">
                {features.map((feature, index) => (
                    <div key={index} className="bg-white/5 p-4 rounded-xl border border-white/10">
                        <h4 className="font-bold text-white mb-3 text-sm">{feature.category}</h4>
                        <div className="space-y-2">
                            <div className="flex justify-between items-center py-2 border-b border-white/10">
                                <span className="text-gray-400 text-xs">Free</span>
                                <span className="text-gray-300 text-xs text-right">{feature.values[0]}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-white/10">
                                <span className="text-gray-400 text-xs">Individual Basic</span>
                                <span className="text-gray-300 text-xs text-right">{feature.values[1]}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 bg-primary/10 rounded-lg px-2 -mx-2">
                                <span className="text-cyan-400 text-xs font-medium">Individual Pro</span>
                                <span className="text-cyan-400 text-xs font-medium text-right">{feature.values[2]}</span>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="md:hidden p-4 space-y-4">
                {features.map((feature, index) => (
                    <div key={index} className="bg-white/5 p-4 rounded-xl border border-white/10">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center py-2 border-b border-white/10">
                                <span className="text-gray-400 text-xs">Professional Starter</span>
                                <span className="text-gray-300 text-xs text-right">{feature.values[0]}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 bg-primary/10 rounded-lg px-2 -mx-2">
                                <span className="text-cyan-400 text-xs font-medium">Professional Growth</span>
                                <span className="text-cyan-400 text-xs font-medium text-right">{feature.values[1]}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-white/10">
                                <span className="text-gray-400 text-xs">Enterprise</span>
                                <span className="text-gray-300 text-xs text-right">{feature.values[2]}</span>
                            </div>
                        </div>
                    </div>
                ))}
