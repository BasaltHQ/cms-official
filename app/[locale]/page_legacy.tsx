...
const jsonLd = {
    ...
    "description": "An AI CMS that combines predictive sales analytics with autonomous customer support agents."
};
...
export default function LandingPage() {
    ...
    return (
        <div className="dark min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 overflow-x-hidden max-w-full">
            {/* Header */}
            {/* Header */}
            <MarketingHeader />
