                ...
                <div className="fixed inset-0 bg-[#0F0F1A] z-[998] flex flex-col pt-24 px-6 pb-8 lg:hidden overflow-y-auto">
                    ...
                    <div className="mt-auto pt-12 flex justify-center gap-8">
                        ...
                        {socialSettings?.xTwitterUrl && (
                            <a href={socialSettings.xTwitterUrl} target="_blank" rel="noopener noreferrer" aria-label="Follow Ledger on X" className="text-white hover:text-white/90 hover:scale-110 transition-transform duration-200">
                        ...
                        {socialSettings?.discordUrl && (
                            <a href={socialSettings.discordUrl} target="_blank" rel="noopener noreferrer" aria-label="Follow Ledger on Discord" className="text-white hover:text-[#5865F2] hover:scale-110 transition-all duration-200">
                        ...
                        {socialSettings?.githubUrl && (
                            <a href={socialSettings.githubUrl} target="_blank" rel="noopener noreferrer" aria-label="Follow Ledger on GitHub" className="text-white hover:text-[#8B5CF6] hover:scale-110 transition-all duration-200">
